package com.nineinfosys.businesscalcualtors.Report;
...
public class BusinessLoanReport extends AppCompatActivity implements OnChartValueSelectedListener {
    double PrincipalAmount, ToatalInterest,TotalPayment,interestRate,loanPeriod,LoanMonthlyPayment,LoanInterestAmount,LoanAnnualPayment,totalAll,otherfee,documentationfee,originationfee,totalAllfees;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.fullreport:
                ...
                Intent i1 = new Intent(this, BusinessLoanFullReport.class);
               i1.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                ...
                i1.putExtra("documentationfee",documentationfee);
                i1.putExtra("otherfee",otherfee);
                i1.putExtra("totalAllfees", totalAllfees);
